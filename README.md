...
| SAPLMA-L18        | 0.700    | 0.667     | 0.621  | 0.643 | 0.765 |
| Single-L16_H6     | 0.710    | 0.688     | 0.609  | 0.646 | 0.754 |
| Single-L15_H6     | 0.690    | 0.640     | 0.655  | 0.648 | 0.739 |
| Single-L11_H1     | 0.720    | 0.707     | 0.609  | 0.654 | 0.746 |
| Single-L18_H0     | 0.635    | 0.567     | 0.678  | 0.618 | 0.717 |
| Single-L13_H11    | 0.685    | 0.662     | 0.563  | 0.609 | 0.763 |
| 求和探针 (Top-5)  | **0.735**| **0.681** | 0.736  | 0.707 | **0.799** |
| 投票集成 (Top-5)  | 0.725    | 0.722     | 0.598  | 0.654 | 0.795 |

**关键发现**：仅使用 5/336 个注意力头的影响向量，求和探针（AUC 0.799）即超越 SAPLMA（AUC 0.765，使用完整 1536 维隐藏状态），同时揭示了对幻觉检测最关键的注意力头位于第 11-18 层。
